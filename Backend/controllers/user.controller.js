...
// --- REMAINING PROFILE FUNCTIONS (UNCHANGED BUT PROTECTED BY SAME COOKIE LOGIC) ---
...
const getProfile = asyncHandler(async (req, res) => {
  ...
  if (!token) return res.status(200).json(new ApiResponse(200, null, "User not logged in"));
  try {
